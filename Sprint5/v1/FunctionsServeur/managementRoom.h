 ...
 * Paramètre : int dS : socket du serveur à laquelle envoyer le message.
 * */
void welcomeMsg(int dS);

/*
 * Affichage des salons de discussion acessibles ainsi que les clients connectés à ces derniers.
 * Paramètre : int dS : socket du serveur à laquelle envoyer le message.
 * */
...
/*
 * Retire le client du salon actuel et l'ajoute au nouveau salon, dont le nom est passé en paramètre.
 * Paramètres : int numClient : numéro du client.
 *              char * msg : message reçu du client, dans lequel se trouve le nom du salon.
 * */
...
/*
 * Renvoie un booléen signalant s'il y a des clients dans le salon de discussion dont le nom est passé en paramètre. 
 * Paramètres : int numClient : numéro du client.
 * */
 ...
 * Paramètres : int numClient : numéro du client.
 *              char * msg : message reçu du client, dans lequel se trouve la description du salon.
 * */
